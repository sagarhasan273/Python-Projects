...
step 02: Run server.py from cmd or windows powershell or git bash or server application

step 03: At the time of server listening run client.py or Code Chat application
